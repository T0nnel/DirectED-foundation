  ...
  const onSubmit = async (data: ListingFormData) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: data.is_published ? 'Your changes are now live.' : 'Your changes have been saved.',
      });
      navigate('/admin');
    }
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 bg-primary text-primary-foreground shadow-lg">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <span className="font-serif text-xl font-bold">Edit Listing</span>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        >
          <Card>
            <CardHeader>
              <CardTitle className="font-serif text-2xl">Edit Program Listing</CardTitle>
            </CardHeader>
            <CardContent>
              <Form {...form}>
